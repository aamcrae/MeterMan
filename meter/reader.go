...
func NewReader(c *MeterConfig, trace bool) (*Reader, error) {
	...
	d.History = core.ConfigOrDefault(c.History, d.History)
	d.MaxLevels = core.ConfigOrDefault(c.MaxLevels, d.MaxLevels)
	if err != nil {
		return nil, err
	}
	...
	r.savedLevels = core.ConfigOrDefault(c.SavedLevels, 50)
	r.recalInterval = core.ConfigOrDefault(c.RecalibrateInterval, 120)
